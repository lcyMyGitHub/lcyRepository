...
<article class="page-container">
	<form  method="post" class="form form-horizontal" id="form-member-update">

		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>用户名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${user.user_name}" placeholder="长度在2位到16位之间" id="user_name" name="user_name">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="radio-box">
					<input name="user_sex" value="1" type="radio" id="user_sex1" <c:if test="${user.user_sex==1}">checked</c:if> >
					<label for="user_sex1">男</label>
				</div>
				<div class="radio-box">
					<input type="radio" value="2" id="user_sex2"  <c:if test="${user.user_sex==2}">checked</c:if> name="user_sex">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text" value="${user.user_password}" placeholder="长度在6位到16位之间" id="user_password" name="user_password">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>班级：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${user.user_class}" placeholder="xx学院xx专业xx班级" id="user_class" name="user_class">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>学号/工号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${user.user_number}" placeholder="长度9位" id="user_number" name="user_number">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>年龄：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${user.user_age}" placeholder="" id="user_age" name="user_age">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>手机号码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${user.user_phone}" placeholder="长度为11位" id="user_phone" name="user_phone">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">邮箱：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${user.user_email}"  placeholder="xxxx@xxx.xxx" name="user_email" id="user_email">
			</div>
		</div><!--
		<div class="row cl">
		...
		--><div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				...
				<div class="radio-box">
					<input type="radio" value="1" id="user_state2" <c:if test="${user.user_state== 1}">checked</c:if>  name="user_state">
...
/*			user_addtime:{
		...
		submitHandler:function(form){
		  ...
		  $.post('<%=basePath%>userInfo/updateMemberInfoPage',
				{
